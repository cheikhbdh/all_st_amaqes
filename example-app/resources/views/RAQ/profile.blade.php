        ...
        <div class="row">
            ...
            <div class="col-xl-8">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">RAQ</div>
                                </div>
              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <form method="POST" action="{{ route('profil.updateR') }}">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <select id="role" name="role" class="form-control" required>
                        <option value="RAQ" {{ session('user_role') == 'RAQ' ? 'selected' : '' }}>RAQ</option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="POST" action="{{ route('profile.update-passwordR') }}">
                    @csrf
                    @method('PUT')
