...
<head>
  ...
  <title>Pages de connection</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="#" class="logo d-flex align-items-center">
                  <img src="{{ asset('assets/images/amaqes1.jpg') }}" width="50px" height="150px">
                  ...
                  <form class="row g-3 needs-validation" action="{{ route('login.post') }}" method="POST" >
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="email" placeholder="Email" class="form-control" id="yourUsername" required>
