...
<script>
    ...
    $(document).ready(function () {
        $('.deleteButton').on('click', function () {
            ...
            form.attr('action', '/filiereM/' + filiereId);
  ...
  $('#addDepartementBtn').on('click', function () {
    ...
    Swal.fire({
        title: 'Ajouter Filiére au master',
        html: `
            <form id="addForm" action="{{ route('filiere.storeM') }}" method="POST">
                @csrf
                <div class='form-group'>
                    <label for='depSelect'>choisir un filiere un filiere:</label>
                    ${depList}
                </div>
            </form>
        `,
